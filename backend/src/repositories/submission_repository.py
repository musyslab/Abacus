...
class SubmissionRepository():
    ...
    def create_submission(self, team_id: int, user_id: int, output: str, codepath: str, time: str, project_id: int, status: bool, testcase_results: str):
        """Creates a new submission record in the database.

        Args:
            team_id (int): The ID of the team that submitted the code.
            ...
            testcase_results (str): The results of the test cases for the submission.

...
COMPETITION_START = datetime(*COMPETITION_DATE, 17, 0)
COMPETITION_END = datetime(*COMPETITION_DATE, 20, 0)
STUDENT_SUBMISSION_UNLOCK = datetime(2026, 4, 11, 12, 0)

SCOREBOARD_FREEZE = datetime(*COMPETITION_DATE, 19, 30)
SCOREBOARD_RELEASE = datetime(*COMPETITION_DATE, 23, 0)
